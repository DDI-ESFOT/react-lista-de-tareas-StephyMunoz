    ...
    return(
        <div>
            ...
            <table>
                ...
                <tbody>
                {todoList.map((taskAdd, indexList) => (
                    <tr key={indexList}>
                        <td id="taskComplete">{taskAdd}</td>
                        <td>
                            <button onClick={ () => deleteTask(indexList)}>Eliminar</button>
                        </td>
                        <td>
                            <button onClick={() => completedTask(indexList)}>Completada</button>
                        </td>
                    </tr>
